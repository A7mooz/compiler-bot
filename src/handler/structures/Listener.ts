...
import type { Execute, ListenerOptions } from '#types/listener';

export class Listener<
	Rest extends boolean = false,
	Event extends Rest extends true ? keyof RestEvents : keyof ClientEvents = Rest extends true ? keyof RestEvents : keyof ClientEvents
> {
