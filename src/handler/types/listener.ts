import type { CustomInstance, Listener } from '#handler';
import type { Awaitable, ClientEvents, RestEvents } from 'discord.js';
import type { F } from 'ts-toolbelt';

type EventArgs<Event> = Event extends keyof RestEvents ? RestEvents[Event] : Event extends keyof ClientEvents ? ClientEvents[Event] : never;
...
type ExpectedListener = Listener<boolean> | ((instance: CustomInstance) => void);

export type { Execute, ExpectedListener, ListenerOptions };
