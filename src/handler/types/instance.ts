...
type ResolvedInstanceOptions = O.Readonly<O.Required<InstanceOptions, 'ownerIds' | 'testGuildIds' | 'embedColor'>, keyof InstanceOptions, 'deep'>;

export type { InstanceOptions, ResolvedInstanceOptions };
